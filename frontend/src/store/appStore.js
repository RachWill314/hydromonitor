...
export const useAppStore = defineStore('app', () => {
    ...
    */
    ...
    const getFrequencyVariable = async (start, end, variable) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (keys.includes("status")) {
                    ...
                    if (data["status"] == "failed"
                        ...
                        console.log("getFrequencyVariable returned no data");
                    }
                }
            }
            else {
            ...
            console.error('getFrequencyVariable error: ', err.message);
        }
        return []
    }
